...
class CotisationsController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->lesappartements = $lesappartements;
...
//   
   public function detailsAction (){
       ...
       $lesproprietaires = new Application_Model_DbTable_Proprietaires();
       $lesAppartements = new Application_Model_DbTable_Appartements();
       $proprietaire=$lesproprietaires->obtenirProprietaire($id);
       $appartements = $lesAppartements->obtenirAppartementsProp($id);
       $this->view->proprietaire = $proprietaire;
       $this->view->appartements = $appartements;
       $this->view->lesappartements = $lesAppartements;
   }
////       
}